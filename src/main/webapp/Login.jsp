...
<body class="u-body u-xl-mode" data-lang="en">
	<header class="u-clearfix u-header u-header" id="sec-4063">
		<div class="u-clearfix u-sheet u-sheet-1">
			<a href="index.jsp" class="u-image u-logo u-image-1"
				data-image-width="500" data-image-height="254"> <img
				src="images/OIMS_logo2.png" class="u-logo-image u-logo-image-1">
			</a>
			<nav
	...
	<section class="u-align-center u-clearfix u-image u-section-1"
		id="sec-f2e1" data-image-width="1600" data-image-height="1066"
		...
		<div class="u-align-left u-clearfix u-sheet u-sheet-1">
			<div
				...
				<div class="u-container-layout u-container-layout-1">
					<h3
						class="u-custom-font u-font-montserrat u-text u-text-default u-text-1">Login</h3>
					<div
						class="u-expanded-width u-form u-login-control u-white u-form-1">
						<form action="#" method="POST"
							class="u-clearfix u-form-custom-backend u-form-spacing-20 u-form-vertical u-inner-form"
							source="custom" name="form" style="padding: 15px;">
							<div class="u-form-group u-form-name">
								<label for="username-a30d" class="u-label">Registered
									Email *</label> <input type="email"
									placeholder="Enter your registered Email" id="username-a30d"
									name="username"
									class="u-grey-5 u-input u-input-rectangle u-radius-10 u-input-1"
									required="" autofocus="autofocus">
							</div>
							<div class="u-form-group u-form-password">
								<label for="password-a30d" class="u-label">Password *</label> <input
									type="password" placeholder="Enter your Password"
									id="password-a30d" name="password"
									class="u-grey-5 u-input u-input-rectangle u-radius-10 u-input-2"
									required="">
							</div>
							<div class="u-form-checkbox u-form-group">
								<input type="checkbox" id="checkbox-a30d" name="remember"
									value="On"> <label for="checkbox-a30d" class="u-label">Remember
									me</label>
							</div>
							<div class="u-align-right u-form-group u-form-submit">
								<a href="#"
									class="u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-radius-10 u-btn-1">Login</a>
					...
					<a href="#"
						class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-grey-40 u-text-hover-palette-4-base u-btn-2">Forgot
						password?</a> <a href="#"
						class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-create-account u-none u-text-grey-40 u-text-hover-palette-4-base u-btn-3">Don't
						have an account?</a>
				</div>
			</div>
		</div>
